...
public class Car extends Transport {
    ...
    public Car(String brand, String model, int productionYear,
               ...
               double engineVolume, String gearbox, String bodyType,
               String registrationPlateNumber, int seatQuantity,
               boolean winterTyres, Key key) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), engineVolume, gearbox, bodyType, registrationPlateNumber, seatQuantity, winterTyres, key);
    }
